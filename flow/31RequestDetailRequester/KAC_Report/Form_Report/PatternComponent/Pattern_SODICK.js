...
exports.DataSet = async (dataReport, doc, currentY) => {
  try {
    ...
    dataInTable.push([
      "1",
      "Water Circulate Volume (ปริมาณน้ำในระบบ)",
      "LITER",
      dataReport[0].ResultReport,
    ]);
    dataInTable.push([
      "2",
      "Quantity paint use (ปริมาณการใช้สี)",
      "KG/DAY",
      dataReport[1].ResultReport,
    ]);
    dataInTable.push([
      "3",
      "Coating efficiency (ประสิทธิภาพการพ่นสี, สีติดชิ้นงาน)",
      "%",
      dataReport[2].ResultReport,
    ]);
    dataInTable.push([
      "4",
      "Over Spray paint (ปริมาณสีที่พ่นไม่ติดและตกลงน้ำ)",
      "KG/DAY",
      dataReport[3].ResultReport,
    ]);
    dataInTable.push([
      "5",
      "Manufacturing days (จำนวนวันที่ทำงาน)",
      "DAY/MONTH",
      dataReport[4].ResultReport,
    ]);
    dataInTable.push([
      "6",
      "Operating time (เวลาการทำงาน)",
      "Hr./DAY",
      dataReport[5].ResultReport,
    ]);
    dataInTable.push([
      "7",
      "New water changing (รอบการเปลี่ยนน้ำในระบบ)",
      "TIME/YEAR",
      dataReport[6].ResultReport,
    ]);
    ...
    doc.autoTable({
      ...
      columnStyles: {
        //0: {cellWidth : 20},
        0: { fillColor: [211, 239, 240],cellWidth:15},
        //1: { cellWidth: 100 },
        2: { cellWidth: 30 },
        3: { cellWidth: 50 },
      },
    ...
    dataInTable.push([
      "1",
      "pH (ความเป็นกรดด่างของน้ำ)",
      dataReport[7].ControlRange,
      "-",
      dataReport[7].ResultReport,
      dataReport[7].Evaluation,
    ]);
    dataInTable.push([
      "2",
      "Turbidity (ความขุ่นของน้ำ)",
      dataReport[8].ControlRange,
      "NTU",
      dataReport[8].ResultReport,
      dataReport[8].Evaluation,
    ]);
    dataInTable.push([
      "3",
      "Detackification (ความเหนียวของสี)",
      dataReport[9].ControlRange,
      "-",
      dataReport[9].ResultReport,
      dataReport[9].Evaluation,
    ]);
    dataInTable.push([
      "4",
      "Sludge floatation (การลอยตัวของสี)",
      dataReport[10].ControlRange,
      "-",
      dataReport[10].ResultReport,
      dataReport[10].Evaluation,
    ]);
    dataInTable.push([
      "5",
      "Foam (การเกิดฟองของน้ำ)",
      dataReport[11].ControlRange,
      "-",
      dataReport[11].ResultReport,
      dataReport[11].Evaluation,
    ]);
    ...
    doc.autoTable({
      ...
      willDrawCell: function (data) {
        if (data.column.index === 5 && data.section === "body") {
          if (
            dataReport[data.row.index+7].Evaluation == "LOW" ||
            dataReport[data.row.index+7].Evaluation == "HIGH" ||
            dataReport[data.row.index+7].Evaluation == "NOT PASS" ||
            dataReport[data.row.index+7].Evaluation == "NG"
          ) {
