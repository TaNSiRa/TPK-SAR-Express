...
const Pattern_MainP2 = require("./PatternComponent/Pattern_3MainPicSet2Pic.js");
const Pattern_SRK = require("./PatternComponent/Pattern_SRK.js");
...
exports.CreatePDF = async (dataReport) => {
  try {
    ...
    currentY = buffDoc[1];
    //SignSet
    buffDoc = await Pattern_SRK.SignSet(dataReport, doc, currentY);
    doc = buffDoc[0];
    currentY = buffDoc[1];
    //Data Set
    ...
    //Set Pic
    buffDoc = await Pattern_MainP2.PicSet2Pic(dataReport, doc, currentY);
    doc = buffDoc[0];
    currentY = buffDoc[1];
...
exports.CreatePDFSRKAl = async (dataReport) => {
  try {
    var doc = new jsPDF(); // defualt unit mm.
    var pageHeight = doc.internal.pageSize.height;
    var pageWidth = doc.internal.pageSize.width;
