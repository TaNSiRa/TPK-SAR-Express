...
const Pattern_NBCT = require("./PatternComponent/Pattern_NBCT.js");
...
exports.CreatePDF = async (dataReport) => {
  try {
    ...
    //Set CoatingPre
    buffDoc = await Pattern_NBCT.CoatingPre(dataReport, 101, doc, currentY);
    doc = buffDoc[0];
    currentY = buffDoc[1];
    //Set CoatingPre2
    buffDoc = await Pattern_NBCT.CoatingPre(dataReport, 111, doc, currentY);
    doc = buffDoc[0];
    currentY = buffDoc[1];
