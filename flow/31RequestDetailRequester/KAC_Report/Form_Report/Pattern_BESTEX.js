          ...
          for (let j = 0; j < countSpan; j++) {
            if (j == 0) {
              dataInTable.push([
                ...
                dataReport[0][i].ResultReport ? parseFloat(dataReport[0][i].ResultReport).toFixed(1) : '',
                dataReport[1][i].ResultReport ? parseFloat(dataReport[1][i].ResultReport).toFixed(1) : '',
                dataReport[2][i].ResultReport ? parseFloat(dataReport[2][i].ResultReport).toFixed(1) : '',
                dataReport[3][i].ResultReport ? parseFloat(dataReport[3][i].ResultReport).toFixed(1) : '',
              ...
              dataInTable.push([
                ...
                dataReport[0][i + j].ResultReport ? parseFloat(dataReport[0][i + j].ResultReport).toFixed(1) : '',
                dataReport[1][i + j].ResultReport ? parseFloat(dataReport[1][i + j].ResultReport).toFixed(1) : '',
                dataReport[2][i + j].ResultReport ? parseFloat(dataReport[2][i + j].ResultReport).toFixed(1) : '',
                dataReport[3][i + j].ResultReport ? parseFloat(dataReport[3][i + j].ResultReport).toFixed(1) : '',
