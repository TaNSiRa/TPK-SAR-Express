...
const Pattern_BSI = require("./PatternComponent/Pattern_BSI.js");
...
exports.CreatePDF = async (dataReport) => {
  try {
    ...
    //Set BSI
    buffDoc = await Pattern_BSI.CoatingPre(dataReport, doc, currentY);
    doc = buffDoc[0];
    currentY = buffDoc[1];
 
    buffDoc = await Pattern_BSI.Big2Sem(dataReport, doc, currentY);
    doc = buffDoc[0];
    currentY = buffDoc[1]; 
